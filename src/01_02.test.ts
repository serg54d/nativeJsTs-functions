import { CityType, addMoneyToBudget, createMessage, repairHouse, toFireStaff, toHireStaff } from "./01_02";
...
test('Greeting message should be correct for city', () => {
	...
	expect(message).toBe('Hello New York cityzens. I want you be happy. All 100000 men');
});